...
export function mostrarLoading() {
  if (!elements.paragraphCard || !elements.btnAtualizar) return;
...
export function mostrarDadosNaTela(dados: any) {
  ...
  if (elements.dateCard) elements.dateCard.innerText = `${dados?.createDate}`;
